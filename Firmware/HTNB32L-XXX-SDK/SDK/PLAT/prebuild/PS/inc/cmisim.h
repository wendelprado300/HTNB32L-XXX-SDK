...
typedef enum CMI_SIM_PRIM_ID_TAG
{
    ...
    CMI_SIM_SET_SIM_SLEEP_REQ, /* AT$QCSIMSLEEP=<mode>*/
    CMI_SIM_SET_SIM_SLEEP_CNF,
    CMI_SIM_GET_SIM_SLEEP_STATE_REQ, /* AT$QCSIMSLEEP?*/
    CMI_SIM_GET_SIM_SLEEP_STATE_CNF,
    CMI_SIM_SET_SIM_WRITE_COUNTER_REQ, /* AT$QCSWC=<mode>*/
    CMI_SIM_SET_SIM_WRITE_COUNTER_CNF,
    CMI_SIM_GET_SIM_WRITE_COUNTER_MODE_REQ, /*AT$QCSWC? */
    ...
    CMI_SIM_CARRIER_CONFIG_IND,
    CMI_SIM_SIMLOCK_IND = 67,
...
typedef struct CmiSimUsatSetTerminalProfileReqTag
{
    ...
    BOOL                bUsatCommEnable;//USAT common items (e.g. polling, more time) except bip enable or not
...
typedef struct CmiSimLockInd_Tag
{
    BOOL is_sim_invalid;
}CmiSimLockInd;
...
* CMI_SIM_CARRIER_CONFIG_IND
*/
typedef struct CmiSimCarrierConfigIndTag
{
    UINT8                           currOperator;
    BOOL                            reserved;
    UINT16                          reserved1;
}
CmiSimCarrierConfigInd;
