...
typedef enum CMI_MM_PRIM_ID_TAG
{
    ...
    CMI_MM_EMM_TIMER_STATE_IND,         //CmiMmEmmTimerStateInd, $QCEMMTIMERI: <timerId>, <state>[, <timer period>]

    CMI_MM_START_OOS_PLMN_SELECT_REQ,   //CmiMmStartOosPlmnSelectReq, AT$QCPLMNS
    CMI_MM_START_OOS_PLMN_SELECT_CNF,   //CmiMmStartOosPlmnSelectCnf

    CMI_MM_GET_PLMN_SELECT_STATE_REQ = 50,  //CmiMmGetPlmnSelectStateReq, AT$QCPLMNS?
    CMI_MM_GET_PLMN_SELECT_STATE_CNF,       //CmiMmGetPlmnSelectStateCnf

    CMI_MM_PLMN_SELECT_STATE_IND,       //$QCPLMNSI: <state>[,<oosTimeStep>]
    ...
    CMI_MM_GET_PSM_MODE_REQ, //CmiMmGetPsmModeReq, AT$QCPSMR?
    CMI_MM_GET_PSM_MODE_CNF, //CmiMmGetPsmModeCnf
    CMI_MM_PSM_CHANGE_IND,  //CmiMmPsmChangeInd,  AT$QCPSMR:
    //CMI_MM_SNR_CHANGE_IND,
    CMI_MM_SET_REQUESTED_PTW_EDRX_PARM_REQ, //CmiMmSetPtwEdrxParmReq, AT$QCPTWEDRXS=<mode>,...
    ...
    CMI_MM_IPV6_RS_FAIL_REQ,
    CMI_MM_IPV6_RS_FAIL_CNF,
    CMI_MM_GTP_PLMN_SEARCH_REQ,
    CMI_MM_GTP_PLMN_SEARCH_CNF,
    CMI_MM_ABORT_GTP_PLMN_SEARCH_REQ,
    CMI_MM_ABORT_GTP_PLMN_SEARCH_CNF,
 ...
 * CMI_MM_IPV6_RS_FAIL_REQ
 */
 typedef struct CmiMmIpv6RsFailReq_Tag
{
	UINT8 cid;
}CmiMmIpv6RsFailReq;

typedef struct CmiMmRsFailReq_Tag
{
    UINT8 cid; //cid value
}CmiMmRsFailReq;
...
typedef CacCmiEmptySig CmiMmIpv6RsFailCnf;
 ...
 *  AT$QCPTWEDRXS=[<mode>[,<AcT-type>[,<Requested_Paging_time_window>[,<Requested_eDRX_value>]]]]
******************************************************************************/
 ...
 *  AT$QCPTWEDRXS?
 *  $QCPTWEDRXS: <AcT-type>,<Requested_Paging_time_window>,<Requested_eDRX_value>
******************************************************************************/
 ...
 *  AT$QCEMMTIME?
 *  $QCEMMTIME: <time-id>,<state>[,<remainTimeValue>]
******************************************************************************/
 ...
 * //$QCEMMTIME: <timeId>,<timeState>[,<timeValue>]
******************************************************************************/
...
typedef CacCmiEmptySig CmiMmAbortGtpPlmnSearchReq;


typedef struct CmiMmGtpPlmnSearchReq_Tag
{
     UINT32 arfcnList[SUPPORT_MAX_FREQ_NUM];
     UINT8  reqSib1bitmap[SUPPORT_MAX_FREQ_NUM];
     UINT8  sib1required;  
     UINT32 scanDuration; /* in miliSeconds */
	 UINT8       rsvd0;
	 UINT8       rsvd1;

}CmiMmGtpPlmnSearchReq;




typedef struct CmiMmSib1InfoGtpTag
{
...
typedef struct CmiMmBasicCellInfoGtpTag
{
	...
	CmiMmSib1InfoGtp                sib1data;

    UINT8                           cell_sib1_field[3];

	UINT8                           bServingCell;
	  
}CmiMmBasicCellInfoGtp;

typedef struct CmiMmBasicCellElementInfoGtpTag
{
    CmiMmBasicCellInfoGtp                    data;
    struct CmiMmBasicCellElementInfoGtpTag *pNext;
}CmiMmBasicCellInfoGtpElement;


typedef struct CmiMmGtpPlmnSearchCnf_Tag
{ 	
   PlmnListStatus                   status;  //PlmnListStatus
   ChannelScanStatus				ChannelStatus[8];
    		//send new structure for GTP in plmn search cnf
   CmiMmBasicCellInfoGtpElement    *pGtpInfoFirstElement;	
}CmiMmGtpPlmnSearchCnf;


typedef CmiMmGtpPlmnSearchCnf CmiMmAbortGtpPlmnSearchCnf ;
