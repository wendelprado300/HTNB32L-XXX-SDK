...
/**
 * \brief          This function is used to get the either DNS-ID or URI-ID or COMMON NAME any one of them
 *
 * \param buffer   ID write to the buffer
 * \param size     size of the buffer
 * \param cert 	   Represent the structutre for the x509 certificate
 *
 * \return       returns the no.of bytes written into the buffer in success, otherwise negative number in failure
 *
 */

int mbedtls_x509_subjectid_get_dns_uri_cn_id( char *buffer, size_t size,const mbedtls_x509_crt *cert);
