...
#ifndef MBEDTLS_CONFIG_LIBCOAP_H
#define MBEDTLS_CONFIG_LIBCOAP_H
...
//#define MBEDTLS_SSL_MAX_OUT_CONTENT_LEN     (512)   /**< Size of the input / output buffer */
/**
