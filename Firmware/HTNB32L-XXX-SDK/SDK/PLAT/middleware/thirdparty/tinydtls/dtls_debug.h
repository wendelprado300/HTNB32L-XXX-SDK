...
#define dtls_emerg(fmt, ...) DEBUG_TRACE(TINYDTLS, P_DEBUG, fmt, ##__VA_ARGS__)
#define dtls_alert(fmt, ...) DEBUG_TRACE(TINYDTLS, P_DEBUG, fmt, ##__VA_ARGS__)
#define dtls_crit(fmt, ...)  DEBUG_TRACE(TINYDTLS, P_DEBUG, fmt, ##__VA_ARGS__)
#define dtls_warn(fmt, ...)  DEBUG_TRACE(TINYDTLS, P_WARNING, fmt, ##__VA_ARGS__)
#define dtls_notice(fmt, ...) DEBUG_TRACE(TINYDTLS, P_DEBUG, fmt, ##__VA_ARGS__)
#define dtls_info(fmt, ...) DEBUG_TRACE(TINYDTLS, P_INFO, fmt, ##__VA_ARGS__)
#define dtls_debug(fmt, ...) DEBUG_TRACE(TINYDTLS, P_DEBUG, fmt, ##__VA_ARGS__)
